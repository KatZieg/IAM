...
requirejs.config({
    ...
    paths: {
        ...
        ListViewController: 'js/controller/ListViewController'
    }
});
...
requirejs(["mwf", "GenericDialogTemplateViewController", "MyApplication", "MyInitialViewController", "ListViewController"],
    function (mwf) {
